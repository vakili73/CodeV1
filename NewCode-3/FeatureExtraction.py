...
dataset_structure = {
    ...
    "gisette_original": {
        ...
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_a", "schema_1", "schema_2", "schema_3"],
    },
    "homus_original": {
        "model_version": 5,
        "preprocessing": 255,
        "shape": [False, 1],
        "schema": ["schema_d", "schema_1", "schema_2", "schema_3"],
    },
    "letter_original": {
        "model_version": 2,
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_b", "schema_1", "schema_2", "schema_3"],
    },
    "mnist_original": {
        "model_version": 1,
        "preprocessing": 255,
    ...
    "satimage_original": {
        ...
        "preprocessing": None,
        "shape": [False, 4],
        "schema": ["schema_c", "schema_1", "schema_2", "schema_3"],
    },
    "usps_original": {
        "model_version": 1,
        "preprocessing": None,
...
for dataset in dataset_structure.keys():
    ...
    # training phase
    parallel_model.compile(loss='cosine_proximity',
