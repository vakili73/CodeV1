...
model_schema = {
    ...
    "schema_1": [
        ...
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_1"}),
    ],
    "schema_2": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dense", {"units": None, "activation": "linear",
        ...
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_2"}),
    ],
    "schema_3": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dense", {"units": None, "activation": "linear",
        ...
        ("Dense", {"units": 128, "activation": "linear"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_3"}),
    ],
    "schema_4": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ...
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_4"}),
    ],
    "schema_5": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ...
        ("Dense", {"units": 128, "activation": "linear"}),
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_5"}),
    ],
    "schema_6": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ...
        ("Dense", {"units": 128, "activation": "linear"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_6"}),
    ],
    "schema_7": [
        ("Dense", {"units": None, "activation": "linear",
                   "name": "schema_7_dense_none_linear_layer_1", "export": True}),
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_7"}),
    ],
    "schema_8": [
        ("Dense", {"units": None, "activation": "linear",
                   "name": "schema_8_dense_none_linear_layer_2", "export": True}),
        ("Dense", {"units": 128, "activation": "linear"}),
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_8"}),
    ],
    "schema_9": [
        ("Dense", {"units": None, "activation": "linear",
        ...
        ("Dense", {"units": 128, "activation": "linear"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": 1, "activation": "linear", "name": "schema_9"}),
    ],
}
