...
model_schema = {
    ...
    "schema_6": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dense", {"units": None, "activation": "hard_sigmoid",
                   "name": "schema_6_dense_none_hard_sigmoid_layer_1", "export": True}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_6"}),
    ],
    "schema_7": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dense", {"units": None, "activation": "hard_sigmoid",
                   "name": "schema_7_dense_none_hard_sigmoid_layer_2", "export": True}),
        ("Dense", {"units": 128, "activation": "linear"}),
...
dataset_structure = {
    ...
    "gisette_original": {
        ...
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_a", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7"],
    },
    "homus_original": {
        "model_version": 5,
        "preprocessing": 255,
        "shape": [False, 1],
        "schema": ["schema_d", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7"],
    },
    "letter_original": {
        "model_version": 2,
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_b", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7"],
    },
    "mnist_original": {
        "model_version": 1,
        "preprocessing": 255,
    ...
    "satimage_original": {
        ...
        "preprocessing": None,
        "shape": [False, 4],
        "schema": ["schema_c", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7"],
    },
    "usps_original": {
        "model_version": 1,
        "preprocessing": None,
