...
model_schema = {
    ...
    "schema_1": [
        ...
        ("Dense", {"units": None, "activation": "relu",
                   "name": "schema_1_dense_none_relu_layer_0", "export": True}),
    ],
    "schema_3": [
        ("Dense", {"units": None, "activation": "linear",
        ...
        ("Dense", {"units": None, "activation": "relu",
                   "name": "schema_3_dense_none_relu_layer_0", "export": True}),
    ],
    "schema_5": [
        ("Dense", {"units": None, "activation": "linear",
        ...
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": None, "activation": "relu",
                   "name": "schema_5_dense_none_relu_layer_0", "export": True}),
    ],
    # Original schema
    "schema_a": [
        ("Dense", {"units": 128, "activation": "relu",
...
dataset_structure = {
    ...
    "gisette_original": {
        ...
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_a", "schema_1", "schema_3", "schema_5"],
    },
    "homus_original": {
        "model_version": 5,
        "preprocessing": 255,
        "shape": [False, 1],
        "schema": ["schema_d", "schema_1", "schema_3", "schema_5"],
    },
    "letter_original": {
        "model_version": 2,
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_b", "schema_1", "schema_3", "schema_5"],
    },
    "mnist_original": {
        "model_version": 1,
        "preprocessing": 255,
    ...
    "satimage_original": {
        ...
        "preprocessing": None,
        "shape": [False, 4],
        "schema": ["schema_c", "schema_1", "schema_3", "schema_5"],
    },
    "usps_original": {
        "model_version": 1,
        "preprocessing": None,
