...
model_schema = {
    ...
    "schema_1": [
        ...
        ("Dense", {"units": None, "activation": "sigmoid",
                   "name": "schema_1_dense_none_sigmoid_layer_1", "export": True}),
        ("Dropout", {"rate": 0.2}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_1"}),
    ],
    "schema_2": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": None, "activation": "sigmoid",
                   "name": "schema_2_dense_none_sigmoid_layer_1", "export": True}),
        ("Dropout", {"rate": 0.1}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_2"}),
    ],
    "schema_3": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": None, "activation": "sigmoid",
                   "name": "schema_3_dense_none_sigmoid_layer_1", "export": True}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_3"}),
    ],
    "schema_4": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dense", {"units": None, "activation": "sigmoid",
                   "name": "schema_4_dense_none_sigmoid_layer_1", "export": True}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_4"}),
    ],
    "schema_5": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ...
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_5"}),
    ],
    "schema_6": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ...
        ("Dense", {"units": 128, "activation": "sigmoid"}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_6"}),
    ],
    "schema_7": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": None, "activation": "linear",
                   "name": "schema_7_dense_none_linear_layer_2", "export": True}),
        ("Dropout", {"rate": 0.1}),
        ("Dense", {"units": 128, "activation": "sigmoid"}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_7"}),
    ],
    "schema_8": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ...
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": None, "activation": "sigmoid",
                   "name": "schema_8_dense_none_sigmoid_layer_1", "export": True}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_8"}),
    ],
    "schema_9": [
        ("Dense", {"units": 128, "activation": "relu"}),
        ("Dropout", {"rate": 0.5}),
        ("Dense", {"units": 128, "activation": "linear"}),
        ("Dense", {"units": None, "activation": "sigmoid",
                   "name": "schema_9_dense_none_sigmoid_layer_1", "export": True}),
        ("Dense", {"units": None, "activation": "softmax", "name": "schema_9"}),
    ],
    # Original schema
    "schema_a": [
        ("Dense", {"units": 128, "activation": "relu",
...
dataset_structure = {
    ...
    "gisette_original": {
        ...
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_a", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7", "schema_8", "schema_9"],
    },
    "homus_original": {
        "model_version": 5,
        "preprocessing": 255,
        "shape": [False, 1],
        "schema": ["schema_d", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7", "schema_8", "schema_9"],
    },
    "letter_original": {
        "model_version": 2,
        "preprocessing": None,
        "shape": [True, 1],
        "schema": ["schema_b", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7", "schema_8", "schema_9"],
    },
    "mnist_original": {
        "model_version": 1,
        "preprocessing": 255,
    ...
    "satimage_original": {
        ...
        "preprocessing": None,
        "shape": [False, 4],
        "schema": ["schema_c", "schema_1", "schema_2", "schema_3", "schema_4", "schema_5", "schema_6", "schema_7", "schema_8", "schema_9"],
    },
    "usps_original": {
        "model_version": 1,
        "preprocessing": None,
