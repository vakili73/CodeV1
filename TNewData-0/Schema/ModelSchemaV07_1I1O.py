...
# %% 1-INPUT 1-OUTPUT
class ModelSchemaV07_1I1O(BaseSchema):
    def __init__(self):
        super().__init__('ModelSchemaV07_1I1O')
    ...
    def predict(self, x_data):
        ...
        intermediate_feature = intermediate_model.predict(x_data)
        if pd.testing.isiterable(intermediate_feature):
            return zip(names, intermediate_feature)
        else:
            return names, intermediate_feature
